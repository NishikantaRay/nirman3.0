...
$(document).ready(function () {
  ...
  function colorFixes() {
    ...
    $("a.sk__iconbox-icon-link").hover(function () {
      $(this)
        .find('span[class^="icon-"].sk__gradient-fancy-text')
        .css({
          background: "rgb(" + primClrARGBNumbersOnly + ")",
          background:
            "-webkit-gradient(linear, left top, right top, from(rgba(" +
            primClrARGBNumbersOnly +
            ",1)), color-stop(52%, rgba(" +
            primClrBRGBNumbersOnly +
            ",1)), to(rgba(" +
            primClrCRGBNumbersOnly +
            ",1)))",
          background:
            "-o-linear-gradient(left, rgba(" +
            primClrARGBNumbersOnly +
            ",1) 0%, rgba(" +
            primClrBRGBNumbersOnly +
            ",1) 52%, rgba(" +
  ...
  $("#theme-color-master").spectrum({
    ...
    move: function (color) {
      ...
      $("span.sk__iconbox-icon-dash").css({
        background: "rgb(" + primClrARGBNumbersOnly + ")",
        background:
          "-webkit-gradient(linear,left top, left bottom,from(#000),to(#000)) padding-box, -webkit-gradient(linear, left top, right top, from(rgba(" +
          primClrARGBNumbersOnly +
          ",1)), color-stop(50%, rgba(" +
          primClrBRGBNumbersOnly +
          ",1)), to(rgba(" +
          ...
          ",1))) border-box",
        background:
          "-o-linear-gradient(#000,#000) padding-box, -o-linear-gradient(left, rgba(" +
          primClrARGBNumbersOnly +
          ",1) 0%, rgba(" +
          primClrBRGBNumbersOnly +
          ",1) 50%, rgba(" +
          ...
          ",1) 100%) border-box",
        background:
          "linear-gradient(#000,#000) padding-box, linear-gradient(90deg, rgba(" +
          primClrARGBNumbersOnly +
          ",1) 0%, rgba(" +
          primClrBRGBNumbersOnly +
          ",1) 50%, rgba(" +
      ...
      $(".sk__clipped-text, " + ".sk__clipped-text-hover:hover").css({
        "-webkit-background-clip": "text",
      ...
      $(".sk__gradient-fancy-text-back").css({
        ...
        background:
          "-webkit-gradient(linear, left top, right top, from(rgba(" +
          primClrARGBNumbersOnly +
          ",0.7035189075630253)), color-stop(52%, rgba(" +
          primClrBRGBNumbersOnly +
          ",0.4990371148459384)), to(rgba(" +
          primClrCRGBNumbersOnly +
          ",0.4009978991596639)))",
        background:
          "-o-linear-gradient(left, rgba(" +
          primClrARGBNumbersOnly +
          ",0.7035189075630253) 0%, rgba(" +
          primClrBRGBNumbersOnly +
          ",0.4990371148459384) 52%, rgba(" +
          primClrCRGBNumbersOnly +
          ",0.4009978991596639) 100%)",
        background:
          "linear-gradient(90deg, rgba(" +
          primClrARGBNumbersOnly +
          ",0.7035189075630253) 0%, rgba(" +
      ...
      $(".sk__gradient-background-tint").css({
        background: "rgb(" + primClrARGBNumbersOnly + ")",
        background:
          "-o-linear-gradient(315deg, rgba(" +
          primClrARGBNumbersOnly +
          ",0.12290266106442575) 0%, rgba(" +
          primClrBRGBNumbersOnly +
          ",0.07007352941176472) 11%, rgba(" +
          primClrCRGBNumbersOnly +
          ",0) 20%)",
        background:
      ...
      $(".sk__subtle-divider").css({
        ...
        background:
          "-webkit-gradient(linear, left top, right top, from(rgba(" +
          primClrARGBNumbersOnly +
          ",0.3169642857142857)), color-stop(52%, rgba(" +
          primClrBRGBNumbersOnly +
          ",0.20772058823529416)), to(rgba(" +
          primClrCRGBNumbersOnly +
          ",0.14)))",
        background:
          "-o-linear-gradient(left, rgba(" +
          primClrARGBNumbersOnly +
          ",0.3169642857142857) 0%, rgba(" +
          primClrBRGBNumbersOnly +
          ",0.20772058823529416) 52%, rgba(" +
          primClrCRGBNumbersOnly +
          ",0.14) 100%)",
        background:
          "linear-gradient(90deg, rgba(" +
      ...
      $(".gradient-links").css({
        ...
        background:
          "-webkit-gradient(linear, left top, right top, from(rgba(198,198,198,1)), color-stop(25%, rgba(198,198,198,1)), color-stop(43%, rgba(" +
          primClrARGBNumbersOnly +
          ",1)), color-stop(72%, rgba(" +
          primClrBRGBNumbersOnly +
          ",1)), to(rgba(" +
          primClrCRGBNumbersOnly +
          ",1)))",
        background:
          "-o-linear-gradient(left, rgba(198,198,198,1) 0%, rgba(198,198,198,1) 25%, rgba(" +
          primClrARGBNumbersOnly +
          ",1) 43%, rgba(" +
          primClrBRGBNumbersOnly +
          ",1) 72%, rgba(" +
          ...
          ",1) 100%)",
        background:
          "linear-gradient(90deg, rgba(198,198,198,1) 0%, rgba(198,198,198,1) 25%, rgba(" +
          primClrARGBNumbersOnly +
          ",1) 43%, rgba(" +
          primClrBRGBNumbersOnly +
          ",1) 72%, rgba(" +
          ...
          ",1) 100%)",
        filter:
          'progid:DXImageTransform.Microsoft.gradient(startColorstr="#c6c6c6",endColorstr="' +
          primClrC +
          '",GradientType=1)',
      });
      ...
      $(".gradient-links-bright").css({
        ...
        background:
          "-webkit-gradient(linear, left top, right top, from(rgba(255,255,255,1)), color-stop(25%, rgba(255,255,255,1)), color-stop(43%, rgba(" +
          primClrARGBNumbersOnly +
          ",1)), color-stop(72%, rgba(" +
          primClrBRGBNumbersOnly +
          ",1)), to(rgba(" +
          ...
          ",1)))",
        background:
          "-o-linear-gradient(left, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 25%, rgba(" +
          primClrARGBNumbersOnly +
          ",1) 43%, rgba(" +
          primClrBRGBNumbersOnly +
          ",1) 72%, rgba(" +
          ...
          ",1) 100%)",
        background:
          "linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 25%, rgba(" +
          primClrARGBNumbersOnly +
          ",1) 43%, rgba(" +
          primClrBRGBNumbersOnly +
          ",1) 72%, rgba(" +
          ...
          ",1) 100%)",
        filter:
          'progid:DXImageTransform.Microsoft.gradient(startColorstr="#ffffff",endColorstr="' +
          primClrC +
          '",GradientType=1)',
      });

      $(".gradient-links, " + ".gradient-links-bright").css({
        display: "table",
        "-webkit-background-clip": "text",
        "-webkit-text-fill-color": "transparent",
      ...
      $(
        ...
        background: "rgb(" + primClrARGBNumbersOnly + ")",
        background:
          "-moz-linear-gradient(90deg, rgba(" +
          primClrARGBNumbersOnly +
          ",0) 45%, rgba(" +
          primClrARGBNumbersOnly +
          ",0.25253851540616246) 62%, rgba(" +
          primClrBRGBNumbersOnly +
          ",0.35898109243697474) 85%, rgba(" +
          primClrCRGBNumbersOnly +
          ",0.5158438375350141) 99%, rgba(" +
          primClrDRGBNumbersOnly +
          ",0.8239670868347339) 100%)",
        background:
      ...
      var updateCSS =
        "<style>.btn-gradient-outline:before, " +
  ...
  $(document).on("click", "#getCSSLauncher", function () {
    $("#stylesForDwnLoad").html(
      "<br>" +
        ...
        primClrARGBNumbersOnly +
        ");<br>" +
        "&nbsp;&nbsp;&nbsp;&nbsp;background: -webkit-gradient(linear,left top, left bottom,from(#000),to(#000)) padding-box, -webkit-gradient(linear, left top, right top, from(rgba(" +
        primClrARGBNumbersOnly +
        ",1)), color-stop(50%, rgba(" +
        primClrBRGBNumbersOnly +
        ",1)), to(rgba(" +
        primClrCRGBNumbersOnly +
        ",1))) border-box;<br>" +
        "&nbsp;&nbsp;&nbsp;&nbsp;background: -o-linear-gradient(#000,#000) padding-box, -o-linear-gradient(left, rgba(" +
        primClrARGBNumbersOnly +
        ",1) 0%, rgba(" +
        primClrBRGBNumbersOnly +
        ",1) 50%, rgba(" +
        primClrCRGBNumbersOnly +
        ",1) 100%) border-box;<br>" +
        "&nbsp;&nbsp;&nbsp;&nbsp;background: linear-gradient(#000,#000) padding-box, linear-gradient(90deg, rgba(" +
        primClrARGBNumbersOnly +
        ",1) 0%, rgba(" +
        primClrBRGBNumbersOnly +
        ",1) 50%, rgba(" +
        ...
        primClrARGBNumbersOnly +
        ");<br>" +
        "&nbsp;&nbsp;&nbsp;&nbsp;background: -o-linear-gradient(315deg, rgba(" +
        primClrARGBNumbersOnly +
        ",0.12290266106442575) 0%, rgba(" +
        primClrBRGBNumbersOnly +
        ",0.07007352941176472) 11%, rgba(" +
        ...
        "&nbsp;&nbsp;&nbsp;&nbsp;background: -webkit-gradient(linear, left top, right top, from(rgba(198,198,198,1)), color-stop(25%, rgba(198,198,198,1)), color-stop(43%, rgba(" +
        primClrARGBNumbersOnly +
        ",1)), color-stop(72%, rgba(" +
        primClrBRGBNumbersOnly +
        ",1)), to(rgba(" +
        primClrCRGBNumbersOnly +
        ",1)));<br>" +
        "&nbsp;&nbsp;&nbsp;&nbsp;background: -o-linear-gradient(left, rgba(198,198,198,1) 0%, rgba(198,198,198,1) 25%, rgba(" +
        primClrARGBNumbersOnly +
        ",1) 43%, rgba(" +
        primClrBRGBNumbersOnly +
        ",1) 72%, rgba(" +
        primClrCRGBNumbersOnly +
        ",1) 100%);<br>" +
        "&nbsp;&nbsp;&nbsp;&nbsp;background: linear-gradient(90deg, rgba(198,198,198,1) 0%, rgba(198,198,198,1) 25%, rgba(" +
        primClrARGBNumbersOnly +
        ",1) 43%, rgba(" +
        primClrBRGBNumbersOnly +
        ",1) 72%, rgba(" +
        primClrCRGBNumbersOnly +
        ",1) 100%);<br>" +
        '&nbsp;&nbsp;&nbsp;&nbsp;filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#c6c6c6",endColorstr="' +
        primClrC +
        '",GradientType=1);<br>' +
        "}<br>" +
        "<br>" +
        ...
        "&nbsp;&nbsp;&nbsp;&nbsp;background: -webkit-gradient(linear, left top, right top, from(rgba(255,255,255,1)), color-stop(25%, rgba(255,255,255,1)), color-stop(43%, rgba(" +
        primClrARGBNumbersOnly +
        ",1)), color-stop(72%, rgba(" +
        primClrBRGBNumbersOnly +
        ",1)), to(rgba(" +
        primClrCRGBNumbersOnly +
        ",1)));<br>" +
        "&nbsp;&nbsp;&nbsp;&nbsp;background: -o-linear-gradient(left, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 25%, rgba(" +
        primClrARGBNumbersOnly +
        ",1) 43%, rgba(" +
        primClrBRGBNumbersOnly +
        ",1) 72%, rgba(" +
        primClrCRGBNumbersOnly +
        ",1) 100%);<br>" +
        "&nbsp;&nbsp;&nbsp;&nbsp;background: linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 25%, rgba(" +
        primClrARGBNumbersOnly +
        ",1) 43%, rgba(" +
        primClrBRGBNumbersOnly +
        ",1) 72%, rgba(" +
